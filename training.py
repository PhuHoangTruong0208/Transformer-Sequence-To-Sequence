...
class TransformersTraining:
    def __init__(self, d_model=512, batch_size=30, ffn_hidden=2048, num_heads=8, dropout=0.1, vocab_size=len(GetIndex().vocab)+1,
        ...
        self.transformer_model = TranformersModel(d_model=d_model, ffn_hidden=ffn_hidden, num_heads=num_heads,
                                    dropout=dropout, num_layers=num_layers, to_index=self.char_to_index, max_sequence_length=self.preprocess.sequence_length,
